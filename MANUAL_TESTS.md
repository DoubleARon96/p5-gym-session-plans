...
## Home
There are only two features to test on this page, along with all the links in the navigation bar and the footer.
1. Only super users can see the update button.
2. The update button redirects you to a page where you can make updates.
### Update Button Test
